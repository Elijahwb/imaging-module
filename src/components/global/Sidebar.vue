...
<div class="sidebar" style="background-color: #F6F6F6;">
  <div class="flex items-center justify-center mt-2 top-0 h-16 w-16">
    <div class="text-yellow-650 text-3xl" style="color: #FF782E !important">DS</div>
  </div>
    <a
      href="https://app.projectdental.nl/dashboard"
      class="sidebar-item">
      ...
      <span
        class="popup group-hover:scale-100 scale-0 transition duration-100 transform">
        <div class="m-1 whitepsace-nowrap text-white text-xs">Dashboard</div>
      </span>
    </a>
    <a
      href="https://app.projectdental.nl/frontoffice"
      class="sidebar-item">
      <svg :class="{'text-white scale-100' : isImaging}" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sidebar-icon transition duration-200 transform group-hover:text-white ease-in scale-75 group-hover:scale-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <span
        class="popup group-hover:scale-100 scale-0 transition duration-100 transform">
        <div class="m-1 whitepsace-nowrap text-white text-xs w-auto">FrontOffice</div>
      </span>
    </a>
    <a
    ...
    <a
      href="https://app.projectdental.nl/doctor/appointments"
      class="sidebar-item">
        <svg :class="{'text-white scale-100' : isImaging}" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sidebar-icon transition duration-200 transform group-hover:text-white ease-in scale-75 group-hover:scale-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a href="https://app.projectdental.nl/dashboard"
      class="sidebar-item">
      <svg :class="{'text-white scale-100' : isImaging}" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sidebar-icon transition duration-200 transform group-hover:text-white ease-in scale-75 group-hover:scale-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <router-link to="/"
      class="sidebar-item bg-yellow-650">
      <svg :class="{'text-white scale-100' : isImaging}" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sidebar-icon transition duration-200 transform group-hover:text-white ease-in scale-75 group-hover:scale-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div
    class="h-16 w-16 flex flex-col items-center justify-center group hover:bg-yellow-650 m-1 hover:shadow-md border rounded-lg my-3">
    <svg :class="{'text-white scale-100' : isImaging}" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sidebar-icon transition duration-200 transform group-hover:text-white ease-in scale-75 group-hover:scale-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
  ...
  computed: {
    isDashboard() {
      return this.$router.currentRoute.name === 'doctorDashboard';
    },
    isFront() {
      return this.$router.currentRoute.name === 'Office Dashboard';
    },
    isBilling() {
      return this.$router.currentRoute.fullPath.indexOf('billing') >= 0;
    },
    isPatients() {
    ...
    isReporting() {
      return this.$router.currentRoute.name === 'reporting';
    },
    isInsurance() {
      return this.$router.currentRoute.name === 'Insurance';
    },
    isImaging() {
      return this.$router.currentRoute.name === 'Imaging';
    },
  },
};
</script>
...
<style scoped>
.sidebar {
  @apply fixed w-20 flex flex-col justify-start items-center border-gray-200 h-screen left-0 top-0 z-20 space-y-2 border-r
}
.sidebar-item {
  @apply h-16 w-16 flex flex-col items-center justify-center group hover:bg-yellow-650 m-1 hover:shadow-md border rounded-full my-2
}
.sidebar-icon {
